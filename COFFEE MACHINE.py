...
''')
print(logo)
statement = (Fore.GREEN + "----------ALL YOU NEED IS COFFEE!----------")
print(f"\t\t\t\t{statement}\t\t\t\t")
print("\n\n\n\n")

s = (Fore.GREEN + "WELCOME TO COFFEE MACHINE")
print(f"\t\t{s}\t\t")
print("\n\n\n")
while not coffee_maker:
    ...
    if user_choice == "4":
        ...
        if resources["water"] >= 50 and resources["coffee"] >= 20:
            ...
            if user_money == 60:
                print(Fore.RED + "Take your coffee☕ \n!!Have a nice day!!")
            elif user_money > 60:
                user_change = round((user_money - 60), 2)
                print(Fore.RED +f"Take your coffee☕,\nYour change is {user_change}\n!!Have a nice day!!")
            money += 60
            ...
            print(Fore.RED + "Sorry resources are not enough")
            coffee_maker = False
    elif user_choice == "2":
        if resources["water"] >= 200 and resources["coffee"] >= 30 and resources["milk"] >= 150:
            user_money = money_checker()
            if user_money == 70:
                print(Fore.RED +"Take your coffee☕,!!Have a nice day!!")
            elif user_money > 70:
            ...
            resources["milk"] -= 150
            if user_money < 70:
                print(Fore.RED +"Your transaction is failed and your money is refunded successfully")
        else:
            print(Fore.RED +"Sorry resources are not enough")
            coffee_maker = False
        ...
        if resources["water"] >= 250 and resources["coffee"] >= 40 and resources["milk"] >= 100:
            ...
            if user_money == 80:
                ...
                print(Fore.RED +"Take your coffee☕,")
                print(Fore.RED +"Your change is",user_change)
                print(Fore.RED +"!!Have a nice day!!")
            money += 80
            resources["amount"] = money
            resources["water"] -= 250
            resources["coffee"] -= 35
